...
rules - методы, для отправки сообщений пользователям. Пример фотрмата: {
            "id": 0,
            "users": [
                "group2"
            ],
...
repeat - С какой частотой мы хотим, чтобы сообщения отправлялиь.(Days - отправлять раз в n дней, hours - отправлять раз в n часов, minutes - раз в n минут, none - если хотим, чтобы сообщение отправилось одинь раз).
